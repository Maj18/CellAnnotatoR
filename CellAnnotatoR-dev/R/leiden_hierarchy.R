...
getLeidenHierarchy <- function(p2, out.name, outfile.path, layer.n=3, res.step.layer1=0.01, min.res=0, min.res.update=FALSE, max.res.layer2=1, max.res.increase=3, res.switch=0.1, clustering.type=NULL, embeding.type=NULL, graph=NULL, clf.data=NULL, uncertainty.thresholds=c(coverage=0.5, negative=0.5, positive=0.75), sp.thresholds=list(accuracy=0.6, confusion.rate=2/3)){
