...
# The second one is min, this will definitely decide the cluster number for layer 2. This argument will also decide the cluster number of the lower layers if step.size==0.

# The last one is step.size, it decides the step size of the increase of the confusion.rate.threshold, from min, layer by layer (from layer 2) towards max, and the confusion rate threshold then sticks to this max until the last hierachical layer.
